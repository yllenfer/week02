...
function productCardTemplate(product) {
  ...
  function filterProducts(productList) {
    // Define an array of product IDs that you need (assuming you have the IDs of the 4 tents you need)
    const neededProductIds = ["880RR", "985RF", "989CG", "985PR"];
  
    // Use the filter method to create a new array containing only the products with IDs in neededProductIds
